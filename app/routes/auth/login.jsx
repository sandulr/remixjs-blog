            ...
            <div className="page-content">
                <form method="POST">
                    ...
                    <div className="form-control">
                        ...
                        <input type="text" name="username" id='username' defaultValue={actionData?.fields?.username && actionData?.fields?.username} placeholder="Username" />
                        <div className="error">
                    ...
                    <div className="form-control">
                        ...
                        <input type="password" name="password" id='password' defaultValue={actionData?.fields?.password && actionData?.fields?.password} placeholder="Password" />
                        <div className="error">
